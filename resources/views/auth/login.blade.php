    ...
    <div class="container">
        <div class="flex flex-col justify-center items-center w-full mt-24 ">
            <div class="bg-darkhover bg-opacity-70 my -10 px-10 pt-12 pb-32 rounded-xl">
                <form class=" w-80 md:w-96" method="POST" action="{{ route('login') }}">
                    @csrf

                    <h1 class="text-primary text-center text-3xl lg:text-4xl font-aquire font-bold mb-6 ">Login</h1>
                    <div class="mb-6">
                        ...
                        <div class="flex items-start mb-6">
                            <div class="flex items-center h-5">
                                <input id="remember" type="checkbox" name="remember" id="remember"
                                    ...
                                    class="w-4 h-4 rounded focus:ring-3 bg-gray-700 border-gray-600 focus:ring-primary ring-offset-gray-800 focus:ring-offset-gray-800">
                            </div>
                            <label for="remember" class="ms-2 text-sm font-medium  text-gray-300">Remember
                                me</label>
                        </div>
                        <a href="{{ Route('password.request') }}" class="text-primary text-sm font-light">Forgot Password
                            ?</a>
                    </div>
                    ...
                    <p class="text-white text-sm mt-3">Don't have an account? <a class="text-primary"
