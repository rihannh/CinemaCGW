    ...
    <div class="container">
        <div class="flex flex-col justify-center items-center w-full mt-24 ">
            <div class="bg-darkhover bg-opacity-70 my -10 px-10 pt-12 pb-32 rounded-xl">
                <form class=" w-80 md:w-96" method="POST" action="{{ route('password.update') }}">
                    @csrf

                    <input type="hidden" name="token" value="{{ $token }}">
                    <h1 class="text-primary text-center text-3xl lg:text-4xl font-aquire font-bold mb-6 ">Reset Password</h1>
                    <div class="mb-6">
