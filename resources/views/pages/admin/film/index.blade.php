...
@section('content')
    <h1 class="text-3xl font-bold text-primary">Film</h1>
    ...
    <div class="flex flex-col gap-5  border-gray-200 rounded-lg dark:border-gray-700 mt-3">
        @foreach ($films as $film)
            <a href="#"
                class=" grid grid-flow-row lg:grid-flow-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                    ...
                                    <th><a href="{{ route('film.edit', $film->id) }}"
